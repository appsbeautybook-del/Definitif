...
export default function AdminStyles() {
  ...
  const loadProduits = async () => {
    ...
    const dbItems = dbRes.data?.results || [];
    const shopifyItems = (shopifyRes.data?.products || []).map(p => ({
      id: p.id,
      name: p.name || p.title,
