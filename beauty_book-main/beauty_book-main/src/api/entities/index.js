...
const KNOWN_COLUMNS = {
  ...
  MessageChat: ['id','conversation_id','sender_email','sender_avatar','receiver_email','receiver_avatar','content','attachment_url','is_read','read','reservation_id','is_maria','created_at','updated_at','created_by_id'],
  ...
  Annonce: ['id','title','description','type','target_url','status','pro_email','pro_name','sponsor_name','sponsor_logo','image_url','cta_label','cta_url','pages','budget','start_date','end_date','impressions','clicks','created_at','updated_at','created_by_id'],
