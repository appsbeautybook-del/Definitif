...
const KNOWN_COLUMNS = {
  ...
  Annonce: ['id','title','description','type','target_url','status','pro_email','pro_name','sponsor_name','sponsor_logo','image_url','cta_label','cta_url','budget','start_date','end_date','impressions','clicks','created_at','updated_at','created_by_id'],
