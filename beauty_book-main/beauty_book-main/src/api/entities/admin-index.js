...
const KNOWN_COLUMNS = {
  ...
  Service: ['id','name','title','description','price','category','subcategory','style','images','pro_email','status','addons','tags','rating','reviews_count','max_persons','promo_price','promo_ends_at','created_at','updated_at','created_by_id'],
  ...
  Reservation: ['id','client_email','client_phone','pro_email','pro_name','service_id','service_name','service_price','date','time_slot','end_time_slot','duration_min','persons','total_price','salon_name','salon_address','seats_total','status','payment_status','payment_type','notes','crg_code','created_at','updated_at','created_by_id'],
};
