...
const KNOWN_COLUMNS = {
  ...
  MessageChat: ['id','conversation_id','sender_email','sender_name','sender_avatar','receiver_email','receiver_name','text','type','attachment_url','is_read','read','reservation_id','is_maria','created_at','updated_at','created_by_id'],
