...
const KNOWN_COLUMNS = {
  ...
  Service: ['id','name','title','description','price','duration_min','category','subcategory','style','images','image_url','pro_email','status','addons','tags','rating','reviews_count','max_persons','promo_price','promo_ends_at','created_at','updated_at','created_by_id'],
